...
public class ActivityPlaceListAndMap extends ActionBarActivity{
    ...
    /** initialize the two tabs  **/
        ...
        GeoPoint center = new GeoPoint(6.796877, 79.901778);
    ...
    public void getDataBase() {
        ...
        if(navigationPosition.equals("bank")) {
            ...
            cr = dbHelper.getBankDataFromDatabase(dbHelper);
            ...
            cr = dbHelper.getGasStationDataFromDatabase(dbHelper);
            cr.moveToFirst();
            crString=cr.getColumnName(0);
            ...
            cr = dbHelper.getHistPlacesStationDataFromDatabase(dbHelper);
            cr.moveToFirst();
            crString=cr.getColumnName(0);
            ...
            cr = dbHelper.getHospitalDataFromDatabase(dbHelper);
            cr.moveToFirst();
            crString=cr.getColumnName(0);
